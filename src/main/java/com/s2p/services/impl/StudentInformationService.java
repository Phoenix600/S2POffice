...
public class StudentInformationService implements IStudentInformationService {
    ...
    @Override
    public List<StudentInformationDto> searchStudents(String firstName, String lastName, String email, String collegeName, String degreeName, String semester, String passingYear, Boolean isGraduated) {
        return List.of();
    }
}
