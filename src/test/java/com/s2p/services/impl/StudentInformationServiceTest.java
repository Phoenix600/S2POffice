...
//
//        Optional<Optional<StudentInformationDto>> result = Optional.ofNullable(studentInformationService.getStudentByEmail("pranay@test.com"));
//
//        assertTrue(result.isPresent());
//        assertEquals("Pranay", result.get().get().getFirstName());
//    }
//
//    @Test
...
//
//        Optional<Optional<StudentInformationDto>> result = Optional.ofNullable(studentInformationService.getStudentByEmail("unknown@test.com"));
//
